...
print("="*60)
print("PARAM-1: English to Hindi Fine Tuning (1:1 SARVAM CONTROL TEST)")
print("="*60)
...
# New repo to separate these control weights from your previous attempt
hf_repo_name = "hdahiya/param-1-hindi-translator-bf16-control"
local_save_path = "./param-translator-bf16-control"
...
trainer.train(resume_from_checkpoint="./param-translator-bf16-control/checkpoint-1000")
